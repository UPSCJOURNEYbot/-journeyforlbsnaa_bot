...
FEATURES_TEXT = (
    ...
    "- XP, levels and IST daily streaks (/stats or /xp)\n"
    "- Spaced repetition revision queue (/revise) over saved mistakes\n"
    "- Previous-year-question practice (/pyq) from year-tagged questions\n"
    "- Custom test builder (/buildtest): size, source, difficulty, topics\n"
    "- Opt-in daily study reminders in IST (/remind)\n"
...
HELP_TEXT = (
    ...
    "`/stats` (or `/xp`) -- your XP, level and IST daily streak\n"
    "`/mistakes` -- revise the mistakes you've saved\n"
    "`/revise` -- spaced repetition: what is due today\n"
    "`/weakquiz` -- practise your weakest topics\n"
    "`/pyq [year]` -- previous-year questions from your bank\n"
    "`/buildtest` -- build a custom test (size, source, topics)\n"
    "`/remind [on|off|HH:MM]` -- daily study reminder (IST)\n"
